...
$command = "/usr/bin/nohup /var/www/html/yt-dlp_linux https://www.youtube.com/watch?v=$safe_idstream -o - " .
    ...
    "-f rtsp rtsp://127.0.0.1:554/$idstream >/tmp/yt_dlpdebug.txt 2>&1 &";
exec($command);
...
// Output stream link (only port 554)
echo "<a href='rtsp://enthusiastic-edeline-kmsepr-0cbdd0dd.koyeb.app:554/$idstream'>Watch</a> *Port 554<br>";
